...
import refactoring.model.PointCreator;
...
public class PointCreatorTest {
    ...
    void pointCreateTest() {
        Point newPoint = new PointCreator(new Point(false)).generate(new PointTrueStrategy());
    ...
    void pointNotCreateStatusTrueTest() {
        Point newPoint = new PointCreator(new Point(true)).generate(new PointRandomStrategy());
        assertThat(newPoint.getStatus()).isFalse();
    }
}
